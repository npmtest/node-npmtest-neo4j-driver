...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-neo4j-driver/node_modules/neo4j-driver/lib/v1/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-neo4j-driver/node_modules/neo4j-driver/lib/v1/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">70.37% <small>(38 / 54)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-neo4j-driver/node_modules/neo4j-driver/lib/v1/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
var auth = {
  basic: <span class="fstat-no" title="function not covered" >function basic(username, password) {</span>
<span class="cstat-no" title="statement not covered" >    var realm = arguments.length &gt; 2 &amp;&amp; arguments[2] !== undefined ? arguments[2] : undefined;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (realm) {</span>
<span class="cstat-no" title="statement not covered" >      return { scheme: "basic", principal: username, credentials: password, realm: realm };</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return { scheme: "basic", principal: username, credentials: password };</span>
    }
  },
  custom: <span class="fstat-no" title="function not covered" >function custom(principal, credentials, realm, scheme) {</span>
<span class="cstat-no" title="statement not covered" >    var parameters = arguments.length &gt; 4 &amp;&amp; arguments[4] !== undefined ? arguments[4] : undefined;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (parameters) {</span>
<span class="cstat-no" title="statement not covered" >      return { scheme: scheme, principal: principal, credentials: credentials, realm: realm,</span>
 ...
 * @returns {Driver}
 */
<span class="fstat-no" title="function not covered" >function driver(url, authToken) {</span>
<span class="cstat-no" title="statement not covered" >  var config = arguments.length &gt; 2 &amp;&amp; arguments[2] !== undefined ? arguments[2] : {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  (0, _util.assertString)(url, 'Bolt URL');</span>
<span class="cstat-no" title="statement not covered" >  var scheme = (0, _connector.parseScheme)(url);</span>
<span class="cstat-no" title="statement not covered" >  if (scheme === "bolt+routing://") {</span>
<span class="cstat-no" title="statement not covered" >    return new _routingDriver2.default((0, _connector.parseUrl)(url), USER_AGENT, authToken, config);</span>
  } else <span class="cstat-no" title="statement not covered" >if (scheme === "bolt://") {</span>
<span class="cstat-no" title="statement not covered" >    return new _driver.Driver((0, _connector.parseUrl)(url), USER_AGENT, authToken, config);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    throw new Error("Unknown scheme: " + scheme);</span>
  }
}
&nbsp;
var types = {
